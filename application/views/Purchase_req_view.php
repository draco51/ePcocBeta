  ...
  <table class="table table-bordered" >
    ...
    <tbody>
      <tr>
        ...
        <td><input type="text" class="tdata info" value = "<?php echo $purchase_req_array['itemname']; ?>" readonly>  </td>
        <td><input type="text" name="quantity" class="tdata" value = "<?php echo $purchase_req_array['qty']; ?>" readonly></td>
        <td><input type="text" name="estimated_cost" class="tdata" value = "<?php echo $purchase_req_array['estimatedcost']; ?>" readonly></td>
        <td><input type="text" name="date_of_required" class="tdata" value = "<?php echo $purchase_req_array['datee']; ?>" readonly></td>
      </tr>
      <tr>
        <th scope="row">2</th>
